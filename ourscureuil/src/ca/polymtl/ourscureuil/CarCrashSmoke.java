...
public class CarCrashSmoke extends Node {
	
	static final float HITBOX_WIDTH = 48.0f;
	static final float HITBOX_HEIGHT = 48.0f;
	
	public CarCrashSmoke(Vector2 posStart, String nameOfNode) { //position start is left, bottom corner
	...
	static protected TextureRegion texregDead = new TextureRegion(projectileTextureList, 144, 144, 48, 48); //grenouille morte 
	
	public void SetMovement(Vector2 movement) {
		//car crash smoke does not move
