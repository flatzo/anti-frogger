...
public class FastCar3 extends Projectile {
	
	static final float MAX_SPEED = 1.2f;
	static final float HITBOX_WIDTH = 48.0f;
	static final float HITBOX_HEIGHT = 48.0f;
	static protected TextureRegion trucktexture = new TextureRegion(projectileTextureList, 144, 96, 48, 48);	
	
	public FastCar3( Vector2 posStart ) {
		super ( posStart );
	}
