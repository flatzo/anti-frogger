...
public class Truck1 extends Projectile {
	...
	public Truck1( Vector2 posStart ) {
		super ( posStart, "Truck1" ); // sets X and Y
	...
	public void draw(SpriteBatch batch, float parentAlpha) {
		if(this.x<0.0f) {
			batch.draw(texreg,this.x-48.0f,this.y,this.originX,this.originY,this.width,this.height,-this.scaleX,this.scaleY,this.rotation);
		}
		else {
